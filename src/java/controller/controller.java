    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (pageAction.contains("?excluido=true") || pageAction.contains("?cadastrado=true")) {
                    response.sendRedirect(pageAction); 
                } else {
                    // Para consultas, mantemos o Forward para não perder os dados do request
                    request.getRequestDispatcher(pageAction).forward(request, response);
                }
            } catch (Exception e) {
                e.printStackTrace(); //Mostra erro real x
